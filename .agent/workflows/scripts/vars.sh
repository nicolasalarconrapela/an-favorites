...
DOC_OUTPUT_DIR="${OUTPUT_DIR}/tmp_${DATE}_${TIME}"
CHANGELOG_OUTPUT_FILE="${DOC_OUTPUT_DIR}/CHANGELOG.md"
RELEASE_NOTES_OUTPUT_FILE="${DOC_OUTPUT_DIR}/RELEASE_NOTES.md"
RELEASE_NOTES_ES_OUTPUT_FILE="${DOC_OUTPUT_DIR}/RELEASE_NOTES.es.md"
...
CHANGELOG_OUTPUT_FILE=$CHANGELOG_OUTPUT_FILE
RELEASE_NOTES_OUTPUT_FILE=$RELEASE_NOTES_OUTPUT_FILE
RELEASE_NOTES_ES_OUTPUT_FILE=$RELEASE_NOTES_ES_OUTPUT_FILE
