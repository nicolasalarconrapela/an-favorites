---
description: Git - Textos de PR · Caso C (release/x.y.x → main)
---
...
Production release of version <RELEASE_VERSION>. This PR consolidates all features, improvements and fixes from the development stage for official publication into main.
...
* `PR.txt` debe contener únicamente el cuerpo del Pull Request
* no debe incluir el título del Pull Request dentro del body
* no inventar cambios
...
- [4. Generación de documentación](file:///c:/Users/Developer/Desktop/@anappwilos/afav_TEST/.agent/workflows/Caso%20C/4.md)
