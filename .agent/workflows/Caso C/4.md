...
- evitar detalle técnico interno salvo que sea imprescindible para entender el impacto real
- no describir refactors, reorganizaciones internas, renombres de archivos, cambios de arquitectura o ajustes de mantenimiento si no producen un efecto visible para el usuario
- no convertir el contenido en un changelog técnico; `RELEASE_NOTES` deben explicar resultado, beneficio y efecto de uso
- si un cambio es principalmente técnico, incluirlo solo si mejora claramente estabilidad, rendimiento, compatibilidad o seguridad desde la perspectiva del usuario
- preferir lenguaje orientado a capacidades, experiencia de uso y mejoras percibibles
