---
description: DIFF [1/2] - Ejecución de comando + validación versión · Caso C (releases/x.y.z → main)
---
## Paso anterior
...
Este paso genera el diff base para la publicación hacia `main`.
...
`bash ".agent/workflows/Caso C/2.sh"`
...
- cambiar `Caso C/2.sh` por otro nombre similar
