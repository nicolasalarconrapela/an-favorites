---
description: DIFF [1/2] - Ejecución de comando · Caso A (release/1.3.y → develop)
---
## Paso anterior

- [1. Generación de diff](.agent/workflows/Caso%20A/1.md)
...
`bash ".agent/workflows/Caso A/2.sh"`
...
- cambiar `Caso A/2.sh` por otro nombre similar
...
4. si no existe bloqueo real, continuar automáticamente al siguiente workflow
